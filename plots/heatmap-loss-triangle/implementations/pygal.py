...
class LossTriangleHeatmap(Graph):
    ...
    def _plot(self):
        ...
        label_margin_top = 110
        label_margin_bottom = 120
        ...
        # Draw cells
        value_font_size = min(36, int(min(cell_width, cell_height) * 0.38))
        ...
        legend_font = 28
        legend_x = x_offset + grid_width - 700
        legend_y = y_offset + grid_height + 70
