...
ax.text(aql + 0.002, 0.98, "AQL", fontsize=14, fontweight="bold", color="#555555", ha="left", va="top")
ax.text(ltpd + 0.002, 0.98, "LTPD", fontsize=14, fontweight="bold", color="#555555", ha="left", va="top")
...
ax.annotate(
    f"α = {alpha_value:.2f}",
    xy=(aql, pa_at_aql),
    xytext=(aql + 0.015, pa_at_aql + 0.03),
    fontsize=14,
    color=colors[0],
    fontweight="bold",
...
ax.plot(ltpd, beta_value, "o", color=colors[0], markersize=10, zorder=5)
ax.annotate(
    f"β = {beta_value:.2f}",
    xy=(ltpd, beta_value),
    xytext=(ltpd + 0.015, beta_value + 0.06),
    fontsize=14,
    color=colors[0],
    fontweight="bold",
    arrowprops={"arrowstyle": "-", "color": colors[0], "lw": 1.5},
