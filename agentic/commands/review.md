...
review_image_dir: `<absolute path to codebase>/agentic/runs/<run_id>/<agent_name>/review_img/`
...
- Find the spec file by looking for agentic/specs/*.md files in the diff that match the current branch name
