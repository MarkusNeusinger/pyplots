...
# Style — publication-quality with strong contrast
custom_style = Style(
    background="white",
    ...
    colors=("#306998", "#D4773F", "#555555", "#306998", "#D4773F"),
    opacity="1",
    opacity_hover="1",
    stroke_opacity="1",
    ...
    value_label_font_family="Helvetica, Arial, sans-serif",
)
...
# Convert numpy arrays to pygal XY point lists
...
# Vertical dashed line at p=0.5 — annotation only, hidden from legend
chart.add(None, [(0.5, 0.0), (0.5, 1.0)], stroke_style={"width": 3, "dasharray": "12, 8"})

# Annotation dots at both peaks — highlights that both curves reach max at p=0.5
chart.add(
    None,
    [{"value": (0.5, 0.5), "label": "Gini peak = 0.50"}],
    stroke_style={"width": 0},
    show_dots=True,
    dots_size=18,
    formatter=lambda *a, **kw: "",
)
chart.add(
    None,
