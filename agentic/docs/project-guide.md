...
Preview images are stored in Google Cloud Storage (`anyplot-images` bucket):
...
```
User submits report issue (from anyplot.ai or GitHub)
    |
...
DATABASE_URL=postgresql+asyncpg://user:password@CLOUD_SQL_IP:5432/anyplot
