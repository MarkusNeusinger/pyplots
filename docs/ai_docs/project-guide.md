...
This document contains comprehensive project documentation for AI agents working on the pyplots codebase. For critical rules that must always be visible, see [CLAUDE.md](/CLAUDE.md).
